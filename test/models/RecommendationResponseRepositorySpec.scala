...
class RecommendationResponseRepositorySpec extends PlaySpecification {
  ...
  val recommendationResponseInfoForUpVote =
    RecommendationResponseRepositoryInfo("emailUpVote", recommendationId.stringify, upVote = true, downVote = false, BSONObjectID.generate())
  val recommendationResponseInfoForDownVote =
    RecommendationResponseRepositoryInfo("emailDownVote", recommendationId.stringify, upVote = false, downVote = true, BSONObjectID.generate())
  val recommendationResponseInfoForNoVote =
    RecommendationResponseRepositoryInfo("emailNoVote", recommendationId.stringify, upVote = false, downVote = false, BSONObjectID.generate())
